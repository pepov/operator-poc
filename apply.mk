apply:
	...
	openapi-gen -p api/v1beta1/openapi -h hack/boilerplate.go.txt -i github.com/pepov/operator-poc/api/v1beta1 --input-dirs "k8s.io/apimachinery/pkg/apis/meta/v1,k8s.io/apimachinery/pkg/runtime,k8s.io/apimachinery/pkg/version"
