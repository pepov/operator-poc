...
import (
	...
	"github.com/pepov/operator-poc/internal/controller"
...
func init() {
	...
	utilruntime.Must(whateverv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c964e8d0.example.org",
	...
	if err = (&controller.ConfigReconciler{
		...
		Logger: mgr.GetLogger().WithName("config"),
