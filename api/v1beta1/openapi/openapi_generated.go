...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/pepov/operator-poc/api/v1beta1.Config":               schema_pepov_operator_poc_api_v1beta1_Config(ref),
		"github.com/pepov/operator-poc/api/v1beta1.ConfigList":           schema_pepov_operator_poc_api_v1beta1_ConfigList(ref),
		"github.com/pepov/operator-poc/api/v1beta1.ConfigSpec":           schema_pepov_operator_poc_api_v1beta1_ConfigSpec(ref),
		"github.com/pepov/operator-poc/api/v1beta1.ConfigStatus":         schema_pepov_operator_poc_api_v1beta1_ConfigStatus(ref),
...
func schema_pepov_operator_poc_api_v1beta1_Config(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/pepov/operator-poc/api/v1beta1.ConfigSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/pepov/operator-poc/api/v1beta1.ConfigStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/pepov/operator-poc/api/v1beta1.ConfigSpec", "github.com/pepov/operator-poc/api/v1beta1.ConfigStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pepov_operator_poc_api_v1beta1_ConfigList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ConfigList contains a list of Config",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/pepov/operator-poc/api/v1beta1.Config"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/pepov/operator-poc/api/v1beta1.Config", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pepov_operator_poc_api_v1beta1_ConfigSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"foo": {
						SchemaProps: spec.SchemaProps{
							Description: "Foo is an example field of Config. Edit config_types.go to remove/update",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pepov_operator_poc_api_v1beta1_ConfigStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
