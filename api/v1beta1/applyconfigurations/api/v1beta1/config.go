...
import (
	apiv1beta1 "github.com/pepov/operator-poc/api/v1beta1"
	internal "github.com/pepov/operator-poc/api/v1beta1/applyconfigurations/internal"
...
type ConfigApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *apiv1beta1.ConfigStatus      `json:"status,omitempty"`
}
...
// Experimental!
func ExtractConfig(config *apiv1beta1.Config, fieldManager string) (*ConfigApplyConfiguration, error) {
...
// Experimental!
func ExtractConfigStatus(config *apiv1beta1.Config, fieldManager string) (*ConfigApplyConfiguration, error) {
	return extractConfig(config, fieldManager, "status")
}

func extractConfig(config *apiv1beta1.Config, fieldManager string, subresource string) (*ConfigApplyConfiguration, error) {
	b := &ConfigApplyConfiguration{}
	err := managedfields.ExtractInto(config, internal.Parser().Type("com.github.pepov.operator-poc.api.v1beta1.Config"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
func (b *ConfigApplyConfiguration) WithStatus(value apiv1beta1.ConfigStatus) *ConfigApplyConfiguration {
	b.Status = &value
	return b
}
